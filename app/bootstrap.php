...
$data['categories'] = array(
        array('category'=>array('id'=>1, 'name'=>'Porta retrato', 'slug'=>'#')),
        array('category'=>array('id'=>2, 'name'=>'Quadros', 'slug'=>'#'),
                'children'=>array(
                    array('category'=>array('id'=>3, 'name'=>'Quadro com 12 fotos', 'slug'=>'#'), 'children'=>array()),
                    )),
    );

$data['categories_flatten'] = array(
        8 => $data['categories'][1]['category'],
        7 => $data['categories'][2]['category']
);
...
$data['products'] = array(
        array('quantity' => 0, 'name' => 'Quadro', 'price' => 2.20, 'installments' => 6, 'saleprice' => 1.00, 'categories' => array($data['categories_flatten'][7])),
        array('quantity' => 1, 'name' => 'Porta retrato', 'price' => 2.20, 'installments' => 6, 'saleprice' => 1.00, 'categories' => array($data['categories_flatten'][8])),
        array('quantity' => 1, 'name' => 'Python Dourado 1', 'price' => 2.20, 'installments' => 6),
        array('quantity' => 1, 'name' => 'Python Dourado 2', 'price' => 2.20, 'installments' => 6),
        array('quantity' => 1, 'name' => 'Python Dourado 3', 'price' => 2.20, 'installments' => 6),
        array('quantity' => 1, 'name' => 'Python Dourado 4', 'price' => 2.20, 'installments' => 6),
        array('quantity' => 1, 'name' => 'Python Dourado 5', 'price' => 2.20, 'installments' => 6),
        array('quantity' => 1, 'name' => 'Python Dourado 6', 'price' => 2.20, 'installments' => 6),
        array('quantity' => 1, 'name' => 'Python Dourado 7', 'price' => 2.20, 'installments' => 6),
        array('quantity' => 1, 'name' => 'Python Dourado 8', 'price' => 2.20, 'installments' => 6),
        array('quantity' => 1, 'name' => 'Python Dourado 9', 'price' => 2.20, 'installments' => 6),
    );
